...
// List<String> companiesInPortfolio = portfolioMatcher.getCompanies(input.split(":")[0]);

// // companies in benchmark

// List<String> companiesInBenchMark = portfolioMatcher.getCompanies(input.split(":")[1]);

portfolioMatcher.printTransactions(companiesInPortfolio, companiesInBenchMark);

}

// public void printTransactions(List companiesInPortfolio, List companiesInBenchMark) {
...
// List resultCompanies = new ArrayList();
...
// Collections.sort(resultCompanies, new Comparator(){
...
// private double calculateTotalMarketValue(List companies) {
...
// private Company getSameCompanyFromBenchMarks(List companiesInBenchMark, Company targetCompany) {
